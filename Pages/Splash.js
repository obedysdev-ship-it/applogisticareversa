    ...
    <div className="min-h-screen bg-gradient-to-br from-green-600 to-green-800 flex items-center justify-center">
      <div className="text-center px-6">
        <div className="mb-8 animate-pulse">
          <img 
            src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/b99f28277_splashcaixas.png" 
            alt="Grupo Docemel Logística Reversa" 
            className="mx-auto max-w-sm w-full h-auto drop-shadow-2xl"
          />
        </div>
